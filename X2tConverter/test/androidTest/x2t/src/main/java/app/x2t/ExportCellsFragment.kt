...
class ExportCellsFragment  constructor(): Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater,
            ...
            inflater.inflate(R.layout.fragment_export_cells, container, false)

    // populate the views now that the layout has been inflated
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        items = listOf(
                resources.getString(R.string.xlsx),
                resources.getString(R.string.ods),
                resources.getString(R.string.csv),
                resources.getString(R.string.xlts),
                resources.getString(R.string.ots)
        )
    ...
    companion object {
        fun newInstance(): ExportCellsFragment = ExportCellsFragment()
    }
}