...
class ExportSlidesFragment constructor(): Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater,
            ...
            inflater.inflate(R.layout.fragment_export_slides, container, false)

    // populate the views now that the layout has been inflated
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        items = listOf(
                resources.getString(R.string.pptx),
                resources.getString(R.string.odp),
                resources.getString(R.string.potx),
                resources.getString(R.string.otp)
        )
    ...
    companion object {
        fun newInstance(): ExportSlidesFragment = ExportSlidesFragment()
    }
}